...
const Testimonial = () => {
    ...
    const changeOnClick = (e) => {
        ...
        axios
            .post(baseurl + "/register/testimonial", formData)
            .then((res) => {
    ...
    const deleteuser = async (id) => {
        ...
        const res2 = await fetch(baseurl + `/testimonial/delete/${id}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const update = (name, description,img,id) => {
        setupdatename(name)
...
const changeOnClickupdate = (e) => {
    ...
    e.preventDefault();
     ...
     axios
         .post(baseurl + "/update/testimonials", formData)
         .then((res) => {
                    ...
                    <div className="container-fluid">
                        <div className="row mb-2">
                            <div className="col-sm-6">
                                <h1 className="m-0 text-dark">Testimonial</h1>
                            </div>{/* /.col */}
                            <div className="col-sm-6">
                                ...
                                <>
                                    <div className='border p-2 px-3' key={element._id}>
                                        ...
                                        <div className='border-top mt-2 d-flex align-items-center justify-content-end p-2'>
                                            ...
                                            <button className='btn btn-primary text-white' onClick={() => update(element.name, element.description,element.img,element._id)} data-bs-toggle="modal" data-bs-target="#staticBackdrop1"><EditIcon /></button>
