...
const getdataValuesFun = async () => {
    ...
    setcontractperson(data.contractPerson)
    setestablish(data.establish)
    setemployees(data.employees)
    setdescription(data.description)
    setFile(baseurl+`/uploads/${data.img}`)
...
const changeOnClick = (e) => {
    ...
    e.preventDefault();
     ...
     axios
         .post(baseurl + "/update/companydetails", formData)
         .then((res) => {
            ...
            <form>
              <div className="mb-3 d-flex align-items-center ">
                <div className='mb-1 mx-2 w-50'>
                  ...
                  <select value={getcategory} onChange={onchangedropdown} className='form-control shadow-none'>
                ...
                <div className='mb-1 mx-2 w-50'>
                  ...
                  <select value={getsubcategory} disabled={dropdown} onChange={subcategoryvalue} className='form-control shadow-none'>
              ...
              <div className="mb-3">
                ...
                <textarea type="text" className="form-control shadow-none" required id="exampleFormControlInput1" value={getaddress} onChange={(e) => setaddress(e.target.value)} placeholder="533 E. College Rd.Munster, IN 46321" />
              </div>
              <div className="mb-3">
                <p className="form-label">City</p>
                <select value={getcity} name="Location" className='form-control shadow-none' id="Location" onChange={(e) => setcity(e.target.value)}>
              ...
              <div className='d-flex justify-content-between'>
                <div className='mb-3'>
                  ...
                  <input className='border border-1 mb-3 'accept="image/*" onChange={onChangimage} single type="file" />
                </div>
